...
function buyStock() {
  const amount = 10;
  const cost = market.getStock('AAPL')?.price! * amount;
  bank.withdraw(cost);
...
<template>
  <div>
    ...
    <div class="gap-2 flex flex-col">
      ...
      <button class="btn" @click="buyStock">Buy 10 AAPL shares</button>
      <button class="btn" @click="sellStock">Sell 10 AAPL shares</button>
    </div>
  </div>
</template>
